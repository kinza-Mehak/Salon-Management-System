 ...
 */
public class ShopBridalPackageFragment extends BaseFragment implements View.OnClickListener{

    EditText mEditTextPackageName,mEditTextPackagePrice,mEditTextPackageDescription;
    Button mButtonAddPackage;

    public ShopBridalPackageFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_shop_bridal_package, container, false);
    }
