 ...
 */
public class ShopHairStylePackageFragment extends BaseFragment implements View.OnClickListener{

    EditText mEditTextPackageName,mEditTextPackagePrice,mEditTextPackageDescription;
    Button mButtonAddPackage;
    public ShopHairStylePackageFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_shop_hair_style_package, container, false);
    }
    @Override
