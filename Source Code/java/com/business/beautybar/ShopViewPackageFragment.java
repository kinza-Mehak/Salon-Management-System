 ...
 */
public class ShopViewPackageFragment extends BaseFragment {
    String json_string;
    ...
    public ShopViewPackageFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_shop_view_package, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        json_string=JsonString.fetch_current_shop_packages;
        try {
